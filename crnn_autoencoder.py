...
def rnn_test():
    ...
    trainer = Trainer(64, datamanager, autoencoder, version='rnn', save_path='save/crnn_ae/rnn/', gpu='2')
    # trainer.train(301) # 
    trainer.load_model()
    trainer.cal_loss()
    # trainer.sample(300)
...
def lstm_test():
    ...
    trainer = Trainer(64, datamanager, autoencoder, version='lstm', save_path='save/crnn_ae/lstm/', gpu='1')
    # trainer.train(301) # 
    trainer.load_model()
    trainer.cal_loss()
    # trainer.sample(300)
...
def gru_test():
    ...
    trainer = Trainer(64, datamanager, autoencoder, version='gru', save_path='save/crnn_ae/gru/', gpu='3')
    # trainer.train(301) # 
    trainer.load_model()
    trainer.cal_loss()
    # trainer.sample(300)
...
def tmp():
    datamanager = AirWriting('upper_raw', train_ratio=0.8, expand_dim=3, seed=0)
    autoencoder = AutoEncoder(2, 64, 'gru', [128], [128], 'AE')
    trainer = Trainer(64, datamanager, autoencoder, version='gru', save_path='save/crnn_ae/tmp/', gpu='3')
    trainer.train(301) # 
